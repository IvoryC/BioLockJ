...
# BioLockJ v1.4.0: ${scriptDir}/MAIN_04_UseScript.sh
...
touch "${scriptDir}/MAIN_04_UseScript.sh_Started"
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_04_UseScript.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/MAIN_04_UseScript.sh_Success"
