...
# BioLockJ.v1.4.0: ${scriptDir}/01.0_Hello_World.sh
...
touch "${scriptDir}/01.0_Hello_World.sh_Started"

exec 1>${logDir}/01.0_Hello_World.log
exec 2>&1
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/01.0_Hello_World.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/01.0_Hello_World.sh_Success"
