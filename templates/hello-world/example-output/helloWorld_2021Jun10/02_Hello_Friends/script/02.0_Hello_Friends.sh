...
# BioLockJ.v1.4.0: ${scriptDir}/02.0_Hello_Friends.sh
...
touch "${scriptDir}/02.0_Hello_Friends.sh_Started"

exec 1>${logDir}/02.0_Hello_Friends.log
exec 2>&1
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/02.0_Hello_Friends.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/02.0_Hello_Friends.sh_Success"
