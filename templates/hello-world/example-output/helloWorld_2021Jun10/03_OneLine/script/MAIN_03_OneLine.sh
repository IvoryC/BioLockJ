...
# BioLockJ v1.4.0: ${scriptDir}/MAIN_03_OneLine.sh
...
modDir="${pipeDir}/03_OneLine"
scriptDir="${modDir}/script"
tempDir="${modDir}/temp"
logDir="${modDir}/log"
outputDir="${modDir}/output"

touch "${scriptDir}/MAIN_03_OneLine.sh_Started"
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_03_OneLine.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/MAIN_03_OneLine.sh_Success"
