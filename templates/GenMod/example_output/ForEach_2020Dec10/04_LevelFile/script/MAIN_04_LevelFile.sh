...
# BioLockJ v1.3.15-dev: ${scriptDir}/MAIN_04_LevelFile.sh
...
touch "${scriptDir}/MAIN_04_LevelFile.sh_Started"
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_04_LevelFile.sh_Failures"
    exit ${3}
}
...
executeLine "${scriptDir}/04.0_ForEachFile.sh" ${LINENO}

touch "${scriptDir}/MAIN_04_LevelFile.sh_Success"
